...
|---|---|---|---|---|
| FB-MECH6-b | **Stacker defrag minigame** — the item-free defrag variant (skill instead of the Defrag Tool, same guaranteed clean). | New minigame; the MAINT defrag flow already has the two-variant scaffold. | M | Fresh build — needs interaction design + a new screen. |
