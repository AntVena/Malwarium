...
constexpr SceneRow kScenes[] = {
    ...
    {"null_pointe", &drawNullPointeScene},
    {"zero_day_shrine", &drawZeroDayShrineScene},
    {"mainframe_row", &drawMainframeRowScene},
    {"the_line", &drawTheLineScene},
    {"crt_bench", &drawCrtBenchScene},
    {"ground_station", &drawGroundStationScene},
    {"trace_city", &drawTraceCityScene},
